<%@ Page Title="MultiCodeGenerator" Language="C#" ValidateRequest="false" MasterPageFile="~/CodeGenerator.master" AutoEventWireup="true" CodeFile="MultiCodeGeneratorCopy.aspx.cs" Inherits="MultiCodeGeneratorCopy" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                     ...
                                     <%--   <div class="col-12 col-sm-3" style="margin-bottom: 20px"  Visible="false" >
                                            <div class="col-sm-9">
                                                <label class="custom_check"  Visible="false" >
                                                    <asp:CheckBox ID="CheckViewJoin" runat="server" AutoPostBack="true" OnCheckedChanged="CheckViewJoin_CheckedChanged"   Visible="false"/>
                                                    <span class="checkmark"  Visible="false"></span>
                                                    <h5  Visible="false" style="font-size: 14px" id="HaddingView" runat="server">Using The Joins Click Here</h5>
                                                </label>
                                            </div>
                                        </div>--%>
                                        <div class="col-12 col-sm-4">
                                        ...
                                        <asp:Panel ID="ViewPanel" runat="server" Visible="false">
                                            <div class="row">
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Select Table:</label>
                                                        <asp:DropDownList ID="ddltableOne" CssClass="form-select form-control" OnSelectedIndexChanged="ddltableOne_SelectedIndexChanged" AutoPostBack="true" runat="server"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Enter Alias  Name:</label>
                                                        <asp:TextBox ID="txtAliasOne" class="form-control" ValidationGroup="Page" runat="server"></asp:TextBox>
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    ...
                                                    <div class="form-group local-forms">
                                                        <asp:ListBox ID="listBoxOne" Style="position: absolute" runat="server" Width="100%"  SelectionMode="Multiple"></asp:ListBox>
                                                    </div>
                                                </div>
                                                <div class="col-12" style="margin-bottom: 20px">
                                                    <div class="form-group mb-0" style="float: right;">
                                                        <div class="settings-btns">
                                                            <asp:Button ID="btnOneMove" BackColor="#3d5ee1" BorderColor="#3d5ee1" class="btn btn-primary" runat="server" Text="Column +" CommandArgument="AddOne" OnClick="btnOneMove_Click" />
                                                            <asp:Button ID="btnOneRelationship" BackColor="#3d5ee1" BorderColor="#3d5ee1" class="btn btn-primary" runat="server" Text="Relation +" CommandArgument="relationshipOne" OnClick="btnRelationship_Click" />
                                                ...
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Select Table:</label>
                                                        <asp:DropDownList ID="ddltableTwo" CssClass="form-select form-control" OnSelectedIndexChanged="ddltableTwo_SelectedIndexChanged" AutoPostBack="true" runat="server"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <label>Enter Alias  Name:</label>
                                                        <asp:TextBox ID="txtAliasTwo" class="form-control" ValidationGroup="Page" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-4">
                                                    <div class="form-group local-forms">
                                                        <asp:ListBox ID="LixstBoxTwo" Style="position: absolute" runat="server" Width="100%" SelectionMode="Multiple"></asp:ListBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12" style="margin-bottom: 20px">
                                                    <div class="form-group mb-0" style="float: right;">
                                                        <div class="settings-btns">
                                                            <asp:Button ID="btnTwoMove" BackColor="#3d5ee1" BorderColor="#3d5ee1" class="btn btn-primary" runat="server" Text="Colunm +" CommandArgument="AddTwo" OnClick="btnOneMove_Click" />
                                                            <asp:Button ID="btnTwoRelationship" BackColor="#3d5ee1" BorderColor="#3d5ee1" class="btn btn-primary" runat="server" Text="Relation +" CommandArgument="relationshipTwo" OnClick="btnRelationship_Click" />
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="GridViewColumns" CssClass="table table-bordered" HeaderStyle-CssClass="bg-primary text-white" AutoGenerateColumns="false" runat="server">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Bind Check" >
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="CheckSelect" runat="server" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Display Colunm" >
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="ddlColunm" OnSelectedIndexChanged="ddlColunm_SelectedIndexChanged" AutoPostBack="true" CssClass="form-select form-control" runat="server"></asp:DropDownList>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Store Colunm" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="ddlStoreColunm"  AutoPostBack="true" CssClass="form-select form-control" runat="server"></asp:DropDownList>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Relationship Colunm">
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="ddlRelationshipColunm"  AutoPostBack="true" CssClass="form-select form-control" runat="server"></asp:DropDownList>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Select Show Colunm" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:ListBox ID="listBoxAdd" runat="server" Width="100%" SelectionMode="Multiple" title="Select columns to join"></asp:ListBox>
                                                            &nbsp;&nbsp; &nbsp;
                                                         <asp:Button ID="btnTwoRemo" runat="server" Text="View -" CssClass="MyClass btn btn-danger btn-sm " CommandArgument="listBoxAdd" OnClick="btnOneRemo_Click" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />

                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Select Relationship " Visible="false">
                                                        <ItemTemplate>
                                                            <asp:ListBox ID="listBoxRelationship" runat="server" Width="100%" SelectionMode="Multiple" title="Select columns to join"></asp:ListBox>
                                                            &nbsp;&nbsp; &nbsp;
                                                            <asp:Button ID="btnOneRemo" CssClass="MyClass btn btn-danger btn-sm " runat="server" Text="View -" CommandArgument="listBoxRelationship" OnClick="btnOneRemo_Click" />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
