<%@ Page Title="CodeGenerator" Language="C#" ValidateRequest="false" MasterPageFile="~/CodeGenerator.master" AutoEventWireup="true" CodeFile="CodeGenerator.aspx.cs" Inherits="CodeGenerator" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="card-body">
                            <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                <ContentTemplate>
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="form-title student-info">Single From Generate </h5>
                                        </div>
                                            ...
                                            <div class="form-group local-forms ">
                                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:DropDownList ID="ddlTables" runat="server" CssClass="form-select form-control" AutoPostBack="True" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlTables_SelectedIndexChanged" ValidationGroup="AddSave">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:GridView ID="GridViewColumns" CssClass="table table-bordered" HeaderStyle-CssClass="bg-primary text-white" AutoGenerateColumns="false" runat="server">
                                                <Columns>
                                                    ...
                                                    <%--   <asp:TemplateField HeaderText="DataType Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDataType" runat="server" Text='<%# Bind("DataType") %>'></asp:Label>
                                                            <asp:CheckBox ID="CheckDataType" runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
    ...
    <script>
        ...
        function initializeSelect2() {
            ...
            if (!$("[id*=ddlTables]").hasClass("select2-hidden-accessible")) {
                $("[id*=ddlTables]").select2();

                // Handle Enter key press event
                $("[id*=ddlTables]").on('select2:select', function (e) {
            ...
            if (!$("[id*=ddlDatabases]").hasClass("select2-hidden-accessible")) {
                $("[id*=ddlDatabases]").select2();

                // Handle Enter key press event
                $("[id*=ddlDatabases]").on('select2:select', function (e) {
                    var code = e.keyCode || e.which;
                    if (code == 13) { // 13 is the Enter key code
        ...
        // Re-initialize Select2 after each partial postback
